...
{collision_md_entries}"""
    ...
    with open(os.path.join(root, "fqn_migration_report.md"), "w", encoding="utf-8") as f:
        f.write(migration_md)
    print("Migration report written to fqn_migration_report.md")
        
    with open(os.path.join(root, "fqn_collision_report.md"), "w", encoding="utf-8") as f:
        f.write(collision_md)
    print("Collision report written to fqn_collision_report.md")
