    ...
    def generate(self, system_prompt: str, user_prompt: str) -> str:
        if self.provider == "openai":
            ...
            if "No relevant information was found" in system_prompt and "No relevant information was found" not in user_prompt:
                ...
                user_prompt_lower = user_prompt.lower()
                if "primary subject: variable radius blending" in user_prompt_lower or "variable radius blending" in user_prompt_lower:
                ...
                elif "primary subject: outcome" in user_prompt_lower or ("outcome" in user_prompt_lower and "what is" in user_prompt_lower):
                    return "## Summary\nSeveral API functions return the `outcome` object to signal execution status.\n\n## Relationship Tree\n`outcome` <- `get_layer_type()`\n\n## Related Entities\n- `get_layer_type`\n- `analyze_C1`"
                elif "primary subject: spaposition" in user_prompt_lower or ("spaposition" in user_prompt_lower and "what is" in user_prompt_lower):
                ...
                elif "primary subject: body" in user_prompt_lower:
                ...
                elif "primary subject: face" in user_prompt_lower:
                ...
                elif "primary subject: edge" in user_prompt_lower:
                    return "## Definition\n`EDGE` represents a topological connection between vertices.\n\n## Purpose\nIt provides bounding boundaries for faces.\n\n## Graph Relationships\nInherits from `ENTITY`.\n\n## Related Components\n- `ENTITY`"
                elif "primary subject: entity" in user_prompt_lower or ("what is entity" in user_prompt_lower):
