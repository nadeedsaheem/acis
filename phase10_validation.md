...
Role: This class represents position vectors (points) in 3D Cartesian space that are subject to certain vector and transformation operations. This class is distinct from the @href SPAvector class, which is a displacement and is origin independent.
...
• get()
• get_entity_from_tag()
• remove_tag_reference()
• old_entity_ptr()
• new_entity_ptr()
• entity_ptr()
• owner()
• retrieve_mapped_target_from_source()
• retrieve_mapped_source_from_target()
• owner()
• entity_a()
• entity_b()
• get_return_entity()
...
• element()
• get_entity()
• get_entity_no_create()
• get_next_entity()
• get_next_entity_no_create()
• owner()
• GetEntity()
• GetEntity()
• body()
